...
export const translations: Record<Language, Translations> = {
  id: {
    ...
    outbound: 'PENGIRIMAN BARANG KELUAR',
    services: 'JASA POLES & KIPAS',
    moisture: 'POTONGAN REFAKSI KA',
    finance: 'BUKU KAS & KEUANGAN',
    riceStock: 'LOGISTIK & STOK BERAS',
    ...
    cornStock: 'STOK JAGUNG GUDANG',
    riceStockLabel: 'STOK BERAS GUDANG',
    totalServiceBilling: 'PENDAPATAN JASA POLES',
    ...
    completedBadge: 'SELESAI TIMBANG',
    waitingBadge: 'DALAM ANTREAN',
    completedBadgeTable: 'SELESAI',
    waitingBadgeTable: 'DALAM PROSES',
